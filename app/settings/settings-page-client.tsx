    ...
    <div className="space-y-6">
      ...
      <section className="rounded-[30px] border border-neutral-200 bg-white p-6 shadow-[0_24px_80px_rgba(15,23,42,0.05)] sm:p-8">
        ...
        <div className="mt-8 rounded-3xl border border-neutral-200 bg-neutral-50 px-5 py-5 text-sm leading-7 text-neutral-600">
          We will send the reset link to <span className="font-semibold text-neutral-950">{initialProfile.email}</span>. Use that email to choose a fresh password without typing the current one here.
        </div>
